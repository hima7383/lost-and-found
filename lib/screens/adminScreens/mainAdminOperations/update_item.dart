...
class updateitemview extends StatefulWidget {
  ...
  @override
  State<updateitemview> createState() => _updateitemviewState(
      this.id, this.itemname, this.location, this.description, this.imagelink);
}
...
class _updateitemviewState extends State<updateitemview> {
  ...
  _updateitemviewState(
      this.id, this.itemname, this.location, this.description, this.imageurl);
  ...
  Future<void> intailpic() async {
    imageFile = await getImageXFileByUrl(imageurl);
  }

  Future<void> updateitem(String id, XFile? image1, String itemName,
      String itemDescription, String location) async {
    ...
    await updatepost(id, image1, itemName, itemDescription, location);
