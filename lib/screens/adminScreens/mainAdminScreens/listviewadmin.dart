...
import 'package:lost_and_found/componet/list_builder.dart';
import 'package:lost_and_found/componet/listbuilderadmin.dart';

class Itemviewadmin extends StatefulWidget {
  const Itemviewadmin({super.key});

  @override
  State<Itemviewadmin> createState() => _ItemviewadminState();
}

class _ItemviewadminState extends State<Itemviewadmin> {
  ...
  Future<void> streamsrest() async {
    _dataStreamController.close();
    _dataStreamController = StreamController<List<QueryDocumentSnapshot>>();
    _dataStreamController.add(await retriveall());
    setState(() {});
  }
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState != ConnectionState.waiting) {
            ...
            return RefreshIndicator(
                onRefresh: streamsrest, child: mylistbuildadmin(ok));
          } else {
